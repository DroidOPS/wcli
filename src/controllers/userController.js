    ...
    if (data) {
        if (data == 1) {
            ...
            if (check >= data && point_list.total1 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total1}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 2) {
            ...
            if (check >= get && point_list.total2 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total2}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 3) {
            ...
            if (check >= get && point_list.total3 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total3}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 4) {
            ...
            if (check >= get && point_list.total4 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total4}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 5) {
            ...
            if (check >= get && point_list.total5 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total5}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 6) {
            ...
            if (check >= get && point_list.total6 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total6}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
        ...
        if (data == 7) {
            ...
            if (check >= get && point_list.total7 != 0) {
                ...
                return res.status(200).json({
                    message: `You just received ${point_list.total7}.00RM`,
                    status: true,
                    timeStamp: timeNow,
                });
