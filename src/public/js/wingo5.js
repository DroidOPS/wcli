function showListOrder3(list_orders, x) {
  ...
  socket.on("data-server", function (msg) {
    ...
    setTimeout(() => {
      ...
      .then((data) => {
        ...
        $(".num span").text(`${data.data.money_user}.00 RM `);
      });
      $(".Loading").fadeOut(0);
    }, 1000);
  });
  ...
  fetch("/api/webapi/GetUserInfo")
    ...
    .then((data) => {
      ...
      $(".num span").text(`RM ${data.data.money_user} `);
    });
  ...
  $(".foot .right").click(function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $(".total-box .num span").text(response.money + ".00 RM ");
